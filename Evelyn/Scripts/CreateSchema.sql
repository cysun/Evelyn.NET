...
CREATE TABLE "Books" (
    ...
    CONSTRAINT "FK_Books_Files_EBookFileId" FOREIGN KEY ("EBookFileId") REFERENCES "Files" ("Id"),
    CONSTRAINT "FK_Books_Files_MarkdownFileId" FOREIGN KEY ("MarkdownFileId") REFERENCES "Files" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_Books_Files_ThumbnailFileId" FOREIGN KEY ("ThumbnailFileId") REFERENCES "Files" ("Id")
);
